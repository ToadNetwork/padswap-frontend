import { CurrencyAmount, JSBI, Token, Trade } from '@padswap/sdk'
import React, { useCallback, useContext, useEffect, useMemo, useState } from 'react'
import { ArrowDown } from 'react-feather'
import { CardBody, ArrowDownIcon, Button, IconButton, Text } from '@padswap/uikit'
          ...
          <CardBody>
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <GreyCard style={{ textAlign: 'center', height: '50px', paddingTop: '13px', borderRadius: '100px' }}>
